...
public class DeleteByPrimaryKeyTransfer implements ITransfer {
    ...
    public XmlNode transfer(JavaMethod method, List<DBColumnInfo> dbColumnInfoList, String tableName, JavaClass entityClass) {
        ...
        node.setTag(SqlType.delete.name());
        ...
        XmlContent xmlContent = new XmlContent(tier * MAPPER_BLANK, "delete from " + tableName);
    ...
    public InitMethod initMethod() {
        return InitMethod.deleteByPrimaryKey;
    }
}
